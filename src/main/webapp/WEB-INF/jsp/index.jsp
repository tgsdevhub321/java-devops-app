          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="mb-4 text-start">
                <h5 class="text-secondary">   987 123 and Fast </h5>
              ...
              <div class="d-flex align-items-start mb-3">
                ...
                <div class="flex-1">
                  <p class="mb-0"> this is testing FaresCrew helps you find the most suitable route, schedule, and fare with a smooth and straightforward search process. Everything you need to plan your journey is available in just a few clicks.</p>
                </div>
              </div>
              <div class="d-flex align-items-start mb-3">
                <div class="flex-1">
