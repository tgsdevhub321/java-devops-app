...
<div class="detail-p">
  ...
  <div id="divpricehint" class="tooltipBox tooltip_price" style="display: none;">
      <span class="priceTooltip_close"><i class="fa fa-times pricehint"></i></span>
      <p class="hidden-sm">
          Total price includes Fares and Taxes 
      </p>
  </div>
