...
public class Fare {
    ...
    @JsonProperty("supplierBaseFare")
    private Double supplierBaseFare;
    @JsonProperty("supplierTotalTax")
    private Double supplierTotalTax;
    @JsonProperty("noPax")
    private Integer noPax;
    @JsonProperty("ttlCharge")
    private Double ttlCharge;
    @JsonProperty("issueFees")
    private Double issueFees;
    @JsonProperty("atlFee")
    private Double atlFee;
    @JsonProperty("cardFee")
    private Double cardFee;
    @JsonProperty("onlnProfit")
    private Double onlnProfit;
    @JsonProperty("ccAgntFee")
    private Double ccAgntFee;
    @JsonProperty("agntProfit")
    private Double agntProfit;
    @JsonProperty("ttlProfit")
    private Double ttlProfit;
    @JsonProperty("XeRate")
    ...
    @JsonProperty("supplierBaseFare")
    public Double getSupplierBaseFare() {
        return supplierBaseFare;
    }

    @JsonProperty("supplierBaseFare")
    public void setSupplierBaseFare(Double supplierBaseFare) {
        this.supplierBaseFare = supplierBaseFare;
    }

    @JsonProperty("supplierTotalTax")
    public Double getSupplierTotalTax() {
        return supplierTotalTax;
    }

    @JsonProperty("supplierTotalTax")
    public void setSupplierTotalTax(Double supplierTotalTax) {
        this.supplierTotalTax = supplierTotalTax;
    }
    ...
    @JsonProperty("ttlCharge")
    public void setTtlCharge(Double ttlCharge) {
        this.ttlCharge = ttlCharge;
    }

    @JsonProperty("issueFees")
    public Double getIssueFees() {
        return issueFees;
    }

    @JsonProperty("issueFees")
    public void setIssueFees(Double issueFees) {
        this.issueFees = issueFees;
    }

    @JsonProperty("atlFee")
    public Double getAtlFee() {
        return atlFee;
    }

    @JsonProperty("atlFee")
    public void setAtlFee(Double atlFee) {
        this.atlFee = atlFee;
    }
    ...
    @JsonProperty("onlnProfit")
    public Double getOnlnProfit() {
        return onlnProfit;
    }

    @JsonProperty("onlnProfit")
    public void setOnlnProfit(Double onlnProfit) {
        this.onlnProfit = onlnProfit;
    }

    @JsonProperty("ccAgntFee")
    public Double getCcAgntFee() {
        return ccAgntFee;
    }

    @JsonProperty("ccAgntFee")
    public void setCcAgntFee(Double ccAgntFee) {
        this.ccAgntFee = ccAgntFee;
    }

    @JsonProperty("agntProfit")
    public Double getAgntProfit() {
        return agntProfit;
    }

    @JsonProperty("agntProfit")
    public void setAgntProfit(Double agntProfit) {
        this.agntProfit = agntProfit;
    }

    @JsonProperty("ttlProfit")
    public Double getTtlProfit() {
        return ttlProfit;
    }

    @JsonProperty("ttlProfit")
    public void setTtlProfit(Double ttlProfit) {
        this.ttlProfit = ttlProfit;
    }
