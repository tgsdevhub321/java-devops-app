...
public class SectorDetail {
    ...
    private String airportTerminalFrom;
    @JsonProperty("airportTerminalTo")
    private String airportTerminalTo;
    @JsonProperty("eft")
    private Integer eft;
    ...
    @JsonProperty("airConfirmation")
    private String airConfirmation;
	...
	@JsonProperty("airConfirmation")
    public String getAirConfirmation() {
		return airConfirmation;
	}
    @JsonProperty("airConfirmation")
	public void setAirConfirmation(String airConfirmation) {
		this.airConfirmation = airConfirmation;
	}
    ...
    @JsonProperty("airportTerminalFrom")
    public String getAirportTerminalFrom() {
        return airportTerminalFrom;
    }

    @JsonProperty("airportTerminalFrom")
    public void setAirportTerminalFrom(String airportTerminalFrom) {
        this.airportTerminalFrom = airportTerminalFrom;
    }

    @JsonProperty("airportTerminalTo")
    public String getAirportTerminalTo() {
        return airportTerminalTo;
    }

    @JsonProperty("airportTerminalTo")
    public void setAirportTerminalTo(String airportTerminalTo) {
