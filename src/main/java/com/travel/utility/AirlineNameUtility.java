...
public class AirlineNameUtility
{	
	public static String getAirlineName(String airlineCode) {
		System.out.println("AirlineNameUtility::GetAirlineCode::" + airlineCode);
		...
		String airlineName = airline.get(airlineCode);
		System.out.println("AirlineNameUtility::GetAirlineName::" + airlineName);
		return airlineName;
	}
}
